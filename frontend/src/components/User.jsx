      ...
      <div className='absolute z-10 text-black w-screen'>
        ...
        <div className='bg-white cmd:min-h-[490vh] min-h-[810vh]'>
          ...
          <div className='flex flex-col cmd:flex-row border border-b-[#b1b1b1] cmd:min-h-[62vh]' ref={aboutRef}>
            <div className='flex cmd:gap-10 gap-5 flex-col border border-r-[#b1b1b1] w-full cmd:w-1/3 px-12  cmd:py-20 py-8'>
              ...
              <div className='border border-black rounded-2xl px-3 py-1 w-48 shadow-[2px_4px_4px_rgba(0,0,0,0.8)]'>
                <a href={userPortfolio?.images?.resume || '/BhanupriyaTaraiResume.pdf'} download={userPortfolio?.username + ".pdf" || 'demo.pdf'}>Download My Resume</a>
              </div>
            </div>
            <div className='flex cmd:gap-10 gap-5 flex-col border border-r-[#b1b1b1] cmd:w-1/3  w-full px-12 cmd:py-20 py-8'>
              ...
              <div className='flex flex-col gap-2'>
                ...
                <span><span className='font-[500]'>Email</span> : {userPortfolio?.personalInfo?.email || 'bhanupriyatarai@gmail.com'}</span>
            ...
            <div className='flex flex-wrap justify-center gap-10'>
              ...
              {userPortfolio?.project ? userPortfolio?.project?.map((item) => {
                ...
                <div className=' w-[280px] cmd:w-[370px] h-[320px] border shadow-[2px_4px_4px_rgba(0,0,0,0.5)] rounded-xl overflow-hidden relative hover:cursor-pointer' onMouseOver={() => { setHoveredId('1') }} onMouseLeave={() => setHoveredId(null)}>
                  ...
                  <div className={`absolute left-[22%]  cmd:left-[28%] px-6 py-1.5  bg-[#090909] border-2 border-white text-gray-500 hover:text-white rounded-3xl ${hoveredId == '1' ? 'sitevisible' : 'sitehidden'}`} ref={siteRef}> <a href="https://bhanupriyatarai-create-folio.vercel.app/">View on Site &rarr;</a></div>
                ...
                <div className=' w-[280px] cmd:w-[370px] h-[320px] border shadow-[2px_4px_4px_rgba(0,0,0,0.5)] rounded-xl overflow-hidden relative hover:cursor-pointer' onMouseOver={() => { setHoveredId('2') }} onMouseLeave={() => setHoveredId(null)}>
                  ...
                  <div className={`absolute left-[22%]  cmd:left-[28%] px-6 py-1.5  bg-[#090909] border-2 border-white text-gray-500 hover:text-white rounded-3xl ${hoveredId == '2' ? 'sitevisible' : 'sitehidden'}`} ref={siteRef}> <a href="https://github.com/bhanupriyatarai">View on Site &rarr;</a></div>
                ...
                <div className=' w-[280px] cmd:w-[370px] h-[320px] border shadow-[2px_4px_4px_rgba(0,0,0,0.5)] rounded-xl overflow-hidden relative hover:cursor-pointer' onMouseOver={() => { setHoveredId('3') }} onMouseLeave={() => setHoveredId(null)}>
                  ...
                  <div className={`absolute left-[22%]  cmd:left-[28%] px-6 py-1.5  bg-[#090909] border-2 border-white text-gray-500 hover:text-white rounded-3xl ${hoveredId == '3' ? 'sitevisible' : 'sitehidden'}`} ref={siteRef}> <a href="https://github.com/bhanupriyatarai">View on Site &rarr;</a></div>
                ...
                <div className=' w-[280px] cmd:w-[370px] h-[320px] border shadow-[2px_4px_4px_rgba(0,0,0,0.5)] rounded-xl overflow-hidden relative hover:cursor-pointer' onMouseOver={() => { setHoveredId('4') }} onMouseLeave={() => setHoveredId(null)}>
                  ...
                  <div className={`absolute left-[22%]  cmd:left-[28%] px-6 py-1.5  bg-[#090909] border-2 border-white text-gray-500 hover:text-white rounded-3xl ${hoveredId == '4' ? 'sitevisible' : 'sitehidden'}`} ref={siteRef}> <a href="https://github.com/bhanupriyatarai">View on Site &rarr;</a></div>
                ...
                <div className=' w-[280px] cmd:w-[370px] h-[320px] border shadow-[2px_4px_4px_rgba(0,0,0,0.5)] rounded-xl overflow-hidden relative hover:cursor-pointer' onMouseOver={() => { setHoveredId('5') }} onMouseLeave={() => setHoveredId(null)}>
                  ...
                  <div className={`absolute left-[22%]  cmd:left-[28%] px-6 py-1.5  bg-[#090909] border-2 border-white text-gray-500 hover:text-white rounded-3xl ${hoveredId == '5' ? 'sitevisible' : 'sitehidden'}`} ref={siteRef}> <a href="https://github.com/bhanupriyatarai">View on Site &rarr;</a></div>
                ...
                <div className=' w-[280px] cmd:w-[370px] h-[320px] border shadow-[2px_4px_4px_rgba(0,0,0,0.5)] rounded-xl overflow-hidden relative hover:cursor-pointer' onMouseOver={() => { setHoveredId('6') }} onMouseLeave={() => setHoveredId(null)}>
                  ...
                  <div className={`absolute left-[22%]  cmd:left-[28%] px-6 py-1.5  bg-[#090909] border-2 border-white text-gray-500 hover:text-white rounded-3xl ${hoveredId == '6' ? 'sitevisible' : 'sitehidden'}`} ref={siteRef}> <a href="https://github.com/bhanupriyatarai">View on Site &rarr;</a></div>
              ...
              <div className='bg-white border-2 shadow-[2px_4px_4px_rgba(0,0,0,0.4)] min-h-[70vh] flex flex-col w-[90vw] cmd:w-[45vw] px-5 py-5 cmd:px-8  gap-7 '>
                ...
                <form onSubmit={sendemailSubmit}>
                  <div className='flex flex-col gap-5'>
                    ...
                    <button type='submit' disabled={isSendingEmail} className={`border bg-red-500 text-white hover:bg-black hover:text-white px-2 py-2 transition-colors duration-500 rounded-md ${isSendingEmail ? 'opacity-70 cursor-not-allowed' : ''}`}>
                      {isSendingEmail ? 'Sending...' : 'Send Message'}
                    </button>
                    {/* {isSendingEmail && <span className='text-[12px] text-gray-700'>Sending email...</span>} */}
                  </div>
                </form>
              </div>
              {/* get in touch */}
                ...
                <div className='flex flex-col gap-5'>
                  ...
                  <div className='flex gap-2'>
                    ...
                    <span className='flex flex-col'>
                      ...
                      <span>{userPortfolio?.personalInfo?.email || 'bhanupriyatarai@gmail.com'}</span>
                    </span>
                  </div>
                </div>
                <ul className='flex gap-4'>
          ...
          <div className='mt-20 flex justify-center' ref={resumeRef}>
            <iframe
              src={userPortfolio?.images?.resume || '/BhanupriyaTaraiResume.pdf'}
